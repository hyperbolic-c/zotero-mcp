"""ChatGPT connector compatibility MCP tools."""
...
from zotero_mcp.server_tools.item_tools import get_item_fulltext
...
def register(mcp: FastMCP) -> None:
    mcp.tool(name="search", description="ChatGPT-compatible search wrapper. Performs semantic search and returns JSON results.")(chatgpt_connector_search)
    mcp.tool(name="fetch", description="ChatGPT-compatible fetch wrapper. Retrieves fulltext/metadata for a Zotero item by ID.")(connector_fetch)
